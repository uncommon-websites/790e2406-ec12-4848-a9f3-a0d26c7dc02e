...
<Hero
	title="Build faster. Ship without the stress."
	subtitle="Track changes, catch bugs, and fix failures."
	imageSrc="/generated/image-a-diverse-group-of-professional-engineer.webp"
	centered={false}
/>
<LogoScroller
